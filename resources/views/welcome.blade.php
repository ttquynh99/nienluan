...
<head>
    ...
    <title>PERFUM SHOP | Trang chủ</title>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{('public/frontend/images/logo/log.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.html"><img src="{{('public/frontend/images/logo/log.png')}}" alt="" width="110px"></a>
                        </div>
                        <!-- Main-menu -->
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active" >
                <!-- Single Slider -->
                <img src="{{asset ('public/frontend/images/banner/slide1.jpg')}}" alt="Image">
                <!-- Single Slider -->
                <!-- Single Slider -->
                <img src="{{asset ('public/frontend/images/banner/slide2.jpg')}}" alt="Image">
                <!-- Single Slider -->
                <img src="{{asset ('public/frontend/images/banner/slide3.jpg')}}" alt="Image">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-md-6 col-sm-10">
                        <div class="choice-watch-img mb-40">
                            <img src="{{('public/frontend/images/gallery/choce_watch2.png')}}" alt="">
                        </div>
                    </div>
